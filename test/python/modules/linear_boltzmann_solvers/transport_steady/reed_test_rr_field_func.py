...
if __name__ == "__main__":
    ...
    total_rr_ff = phys.CreateReactionRateDensityFieldFunction("rr_total", "total")
    abs_rr_ff = phys.CreateReactionRateDensityFieldFunction("rr_abs", "absorption")
    block3_total_rr_ff = phys.CreateReactionRateDensityFieldFunction(
        "rr_total_block3", "sigma_t", block_ids=[3]
    )
